// ReportarFallaAprendiz - Pagina de reporte de fallas y errores del sistema con formulario e historial
...
function ReportarFallaAprendiz() {
  return (
    <div className="modulo-aprendiz">
      ...
      <SidebarAprendiz activo="reportar-falla" />
              ...
              <div className="formulario-cuerpo">
                <div className="grupo-campos">
                  ...
                  <div className="grupo-campo campo-completo">
                    <label htmlFor="descripcion">Descripcion Detallada <span className="requerido">*</span></label>
              ...
              <table className="tabla-usuarios">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>El sistema no permite subir archivos al registrar Avances del proyecto</td>
                  ...
                  <tr>
                    ...
                    <td>Mi Perfil muestra informacion de programa desactualizada</td>
                    <td><span className="estado estado-en-proceso"><i className="fas fa-spinner"></i> En proceso</span></td>
                    <td>25 Oct 2023</td>
                  </tr>
                  <tr>
                    <td><strong>#003</strong></td>
                    <td><span className="badge badge-neutral"><i className="fas fa-folder-open"></i> Problema con mi proyecto</span></td>
                    <td>No puedo editar los entregables de mi proyecto registrado</td>
