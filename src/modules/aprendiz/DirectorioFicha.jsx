      ...
      <main className="contenido-principal">
        <div className="contenedor-pagina">
          <div className="encabezado-pagina">
            ...
            <a href="#" className="btn-secundario"><i className="fas fa-arrow-left"></i> Volver a Mensajes</a>
          </div>
          ...
          <div className="seccion-directorio">
            ...
            <div className="directorio-usuarios">
              <div className="tarjeta-usuario">
                ...
                <a href="#" className="btn-primario btn-sm"><i className="fas fa-comment"></i> Enviar mensaje</a>
              </div>
            </div>
          </div>
