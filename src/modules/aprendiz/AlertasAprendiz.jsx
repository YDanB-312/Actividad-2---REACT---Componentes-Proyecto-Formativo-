...
function AlertasAprendiz() {
  return (
    <div className="modulo-aprendiz">
      ...
      <SidebarAprendiz activo="alertas" />
      <main className="contenido-principal">
        <div className="contenedor-alertas">
          <div className="encabezado-pagina">
            <h1 className="titulo-pagina"><i className="fas fa-bell"></i> Mis Alertas <span className="contador-alertas">5 Alertas</span></h1>
            <div>
            ...
            <div className="contenedor-filtros">
              <div className="grupo-filtro">
                ...
                <select id="tipo-Alerta" className="select-filtro" name="tipo_alerta">
                  ...
                  <option value="comentario">Comentarios del instructor</option>
                  <option value="estado">Cambios de estado</option>
                  <option value="sistema">Alertas del sistema</option>
                </select>
              </div>
              <div className="grupo-filtro">
          ...
          <div className="lista-alertas">
            ...
            <div className="tarjeta-alerta alerta-informativa">
              <div className="contenido-alerta">
                ...
                <div className="info-alerta">
                  ...
                  <div className="acciones-alerta">
                    <a href="#" className="btn-primario"><i className="fas fa-comments"></i> Ver Comentarios</a>
                    <button className="btn-primario" type="button"><i className="fas fa-check"></i> Marcar como leida</button>
                  </div>
                </div>
              </div>
            ...
            <div className="tarjeta-alerta alerta-informativa">
              <div className="contenido-alerta">
                ...
                <div className="info-alerta">
                  <h3>Recordatorio de Avances</h3>
                  <p>Recuerda registrar los Avances de tu proyecto antes del 30 de noviembre para mantener actualizado el seguimiento.</p>
                  <div className="meta-alerta">
                    <div>
                      <span className="fecha-alerta">Hace 2 semanas</span>
                      <span className="proyecto-alerta">Todos los proyectos</span>
                      <span className="badge badge-primario">Recordatorio</span>
                    </div>
                  </div>
                  <div className="acciones-alerta">
                    <a href="#" className="btn-primario"><i className="fas fa-chart-line"></i> Registrar Avances</a>
                    <button className="btn-primario" type="button"><i className="fas fa-check"></i> Marcar como leida</button>
                  </div>
                </div>
              </div>
