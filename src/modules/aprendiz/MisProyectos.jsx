      ...
      <main className="contenido-principal">
        <div className="contenedor-proyectos">
          <div className="encabezado-pagina">
            ...
            <a href="#" className="btn-primario"><i className="fas fa-plus"></i> Nuevo Proyecto</a>
          </div>
          ...
          <section className="lista-proyectos">
            <div className="tarjeta-proyecto">
              ...
              <div className="acciones-proyecto">
                <a href="#" className="btn-secundario btn-sm" aria-label="Ver detalles"><i className="fas fa-eye"></i> Ver</a>
                <a href="#" className="btn-secundario btn-sm" aria-label="Editar proyecto"><i className="fas fa-edit"></i> Editar</a>
              </div>
            </div>
            <div className="tarjeta-proyecto">
              <div className="info-proyecto">
