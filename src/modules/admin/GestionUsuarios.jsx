      ...
      <main className="contenido-principal">
        <div className="contenedor-gestion">
          <div className="encabezado-pagina">
            ...
            <a href="#" className="btn-primario"><i className="fas fa-user-plus"></i> Nuevo Usuario</a>
          </div>
                  ...
                  <tr>
                    ...
                    <td>
                      <div className="acciones-tabla">
                        <a href="#" className="btn-accion-tabla btn-ver" title="Editar"><i className="fas fa-edit"></i></a>
