...
function CrearFicha() {
  return (
    <div className="modulo-instructor">
      ...
      <SidebarInstructor activo="crear-ficha" />
          ...
          <form action="#" className="formulario-proyecto">
            <section className="seccion-formulario">
              ...
              <div className="grupo-formulario">
                <label htmlFor="ficha" className="etiqueta requerido">Código de Ficha</label>
                <input type="text" id="ficha" className="input-text" placeholder="Ej: ADSO-2568" required name="ficha" />
