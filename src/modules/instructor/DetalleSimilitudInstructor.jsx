      ...
      <main className="contenido-principal">
        <div className="contenedor-pagina">
          ...
          <div className="encabezado-pagina">
            ...
            <a href="#" className="btn-secundario"><i className="fas fa-arrow-left"></i> Volver a Alertas</a>
          </div>
          <div className="tarjeta-revision mb-30">
            ...
            <div className="comentarios-revision">
              ...
              <div className="flex-row flex-wrap">
                <a href="#" className="btn-primario"><i className="fas fa-check"></i> Marcar como Revisada</a>
                <a href="#" className="btn-secundario"><i className="fas fa-envelope"></i> Contactar Aprendiz</a>
