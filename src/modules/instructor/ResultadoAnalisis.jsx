      ...
      <main className="contenido-principal">
        <div className="contenedor-ia">
          <div className="encabezado-pagina">
            ...
            <a href="#" className="btn-secundario"><i className="fas fa-arrow-left"></i> Volver a Mis proyectos</a>
          </div>
              ...
              <table className="tabla-similitudes">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>Resumen</td>
                    <td><a href="#" className="btn-ver"><i className="fas fa-eye"></i> Ver</a></td>
                  </tr>
                  <tr>
          ...
          <div className="acciones-finales">
            <a href="#" className="btn-primario"><i className="fas fa-check"></i> Guardar y continuar</a>
            <a href="#" className="btn-secundario"><i className="fas fa-edit"></i> Editar proyecto</a>
          </div>
        </div>
      </main>
      <FooterInstructor />
