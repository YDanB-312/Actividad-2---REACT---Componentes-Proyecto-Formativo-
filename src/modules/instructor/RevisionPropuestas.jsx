...
function RevisionPropuestas() {
  return (
    <div className="modulo-instructor">
      ...
      <SidebarInstructor activo="revision-propuestas" />
          ...
          <div className="lista-propuestas">
            <div className="tarjeta-propuesta">
              ...
              <div className="acciones-propuesta">
                <a href="#" className="btn-primario"><i className="fas fa-check"></i> Aprobar</a>
                <a href="#" className="btn-secundario"><i className="fas fa-comment"></i> Agregar Observaciones</a>
                <a href="#" className="btn-ver"><i className="fas fa-times"></i> Rechazar</a>
                <a href="#" className="btn-ver"><i className="fas fa-eye"></i> Ver Detalles</a>
              </div>
            </div>
            <div className="tarjeta-propuesta">
              <div className="encabezado-propuesta">
            ...
            <div className="tarjeta-propuesta">
              ...
              <div className="acciones-propuesta">
                <a href="#" className="btn-primario"><i className="fas fa-check"></i> Aprobar</a>
                <a href="#" className="btn-secundario"><i className="fas fa-comment"></i> Editar Observaciones</a>
                <a href="#" className="btn-ver"><i className="fas fa-times"></i> Rechazar</a>
              </div>
            </div>
          </div>
