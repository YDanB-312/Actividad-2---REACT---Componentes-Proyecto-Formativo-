    ...
    <div className="modulo-instructor">
      ...
      <main className="contenido-principal">
        <div className="contenedor-revision">
          ...
          <div className="tarjeta tarjeta-padded mb-30">
            <h2 className="titulo-seccion"><i className="fas fa-chart-line"></i> Avances del Proyecto</h2>
              ...
              <table className="tabla-similitudes">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>75%</td>
                    <td><span className="badge badge-advertencia">En revisión</span></td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <div className="seccion-reporte">
            ...
            <div className="lista-observaciones">
              <div className="observacion-item">
                <div className="observacion-header">
                  ...
                  <div className="observacion-acciones">
                    ...
                    <a href="#" className="btn-icono eliminar" title="Eliminar observación"><i className="fas fa-trash-alt"></i></a>
                  </div>
                </div>
                ...
                <div className="observacion-edit-form oculto">
                  <form action="#">
                    <textarea className="textarea" name="observacion">El proyecto necesita mejorar la sección de análisis de requisitos. Se recomienda ampliar la documentación técnica antes de continuar con el desarrollo.</textarea>
              ...
              <div className="observacion-item">
                ...
                <div className="observacion-edit-form oculto">
                  <form action="#">
                    <textarea className="textarea" name="observacion">He realizado los ajustes sugeridos en la documentación. La nueva versión incluye diagramas de flujo y casos de uso detallados. Quedo atento a más retroalimentación.</textarea>
                    <div className="acciones-formulario acciones-edit">
                      <button type="submit" className="btn-primario btn-sm"><i className="fas fa-save"></i> Guardar Cambios</button>
                      <button type="button" className="btn-secundario btn-sm cancelar-edit"><i className="fas fa-times"></i> Cancelar</button>
                    </div>
              ...
              <div className="observacion-item">
                ...
                <div className="observacion-edit-form oculto">
                  <form action="#">
                    <textarea className="textarea" name="observacion">La propuesta inicial tiene buen enfoque, pero falta definir mejor los entregables del primer sprint. Recomiendo revisar la guía de proyectos para alinear expectativas.</textarea>
                    <div className="acciones-formulario acciones-edit">
                      <button type="submit" className="btn-primario btn-sm"><i className="fas fa-save"></i> Guardar Cambios</button>
                      <button type="button" className="btn-secundario btn-sm cancelar-edit"><i className="fas fa-times"></i> Cancelar</button>
                    </div>
            ...
            <div className="tarjeta tarjeta-padded mb-30">
              ...
              <form action="#">
                <div className="grupo-formulario">
                  ...
                  <textarea id="observacion" className="textarea" placeholder="Escribe tu observación sobre el proyecto..." name="observacion"></textarea>
                </div>
          ...
          <div className="acciones-finales">
            <a href="#" className="btn-primario"><i className="fas fa-clipboard-check"></i> Evaluar Avances</a>
            <a href="#" className="btn-secundario"><i className="fas fa-arrow-left"></i> Volver</a>
          </div>
        </div>
      </main>
