...
function AlertasInstructor() {
  return (
    <div className="modulo-instructor">
      ...
      <SidebarInstructor activo="alertas" />
      <main className="contenido-principal">
        <div className="contenedor-alertas">
          <div className="encabezado-pagina">
            <h1 className="titulo-pagina"><i className="fas fa-bell"></i> Alertas <span className="contador-alertas">6 Alertas</span></h1>
            <div>
          ...
          <section className="seccion-filtros">
            <h3 className="filtros-titulo"><i className="fas fa-filter"></i> Filtrar Alertas</h3>
          ...
          <div className="lista-alertas">
              ...
              <div className="contenido-alerta">
                ...
                <div className="info-alerta">
                  ...
                  <div className="acciones-alerta">
                    <a href="#" className="btn-primario"><i className="fas fa-search"></i> Revisar Similitud</a>
            ...
            <div className="tarjeta-alerta alerta-advertencia">
              <div className="contenido-alerta">
                ...
                <div className="info-alerta">
                  ...
                  <div className="acciones-alerta">
                    <a href="#" className="btn-primario"><i className="fas fa-eye"></i> Ver proyecto</a>
                    <button className="btn-primario" type="button"><i className="fas fa-check"></i> Marcar como leída</button>
                  </div>
                </div>
              </div>
            ...
            <div className="tarjeta-alerta alerta-advertencia">
              <div className="contenido-alerta">
                <div className="icono-alerta"><i className="fas fa-chart-line"></i></div>
                <div className="info-alerta">
                  <h3>Nuevo Avance Pendiente de Revisión</h3>
                  <p><strong>María González</strong> registró un nuevo Avance del proyecto "App Móvil para Turismo Local" con un <strong>75% de progreso</strong>. El Avance incluye evidencias y requiere tu evaluación.</p>
                  <div className="meta-alerta">
                    <div>
                      <span className="fecha-alerta">Hace 8 horas</span>
                      <span className="proyecto-alerta">App Móvil para Turismo Local</span>
                      <span className="badge badge-advertencia">Advertencia</span>
                    </div>
                  </div>
                  <div className="acciones-alerta">
                    <a href="#" className="btn-primario"><i className="fas fa-clipboard-check"></i> Evaluar Avance</a>
                    <button className="btn-primario" type="button"><i className="fas fa-check"></i> Marcar como leída</button>
                  </div>
                </div>
              </div>
            ...
            <div className="tarjeta-alerta alerta-informativa">
              <div className="contenido-alerta">
                ...
                <div className="info-alerta">
                  ...
                  <div className="acciones-alerta">
                    <a href="#" className="btn-primario"><i className="fas fa-tasks"></i> Revisar Propuesta</a>
                    <button className="btn-primario" type="button"><i className="fas fa-check"></i> Marcar como leída</button>
                  </div>
                </div>
              </div>
            ...
            <div className="tarjeta-alerta alerta-informativa">
              <div className="contenido-alerta">
                ...
                <div className="info-alerta">
                  <h3>Recordatorio: Evaluaciones Pendientes</h3>
                  <p>Tienes <strong>4 evaluaciones de Avance</strong> pendientes por revisar. La fecha límite para completar las Revisiones es el 30 de noviembre. Recuerda proporcionar retroalimentación detallada.</p>
                  <div className="meta-alerta">
                    <div>
                  ...
                  <div className="acciones-alerta">
                    <a href="#" className="btn-primario"><i className="fas fa-clipboard-list"></i> Ver Evaluaciones</a>
                    <button className="btn-primario" type="button"><i className="fas fa-check"></i> Marcar como leída</button>
                  </div>
                </div>
              </div>
