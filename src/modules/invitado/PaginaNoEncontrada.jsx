/*
Pagina: PaginaNoEncontrada (404)
Funcion: Pagina de error 404
Proposito: Mostrar mensaje cuando una pagina no existe
*/
    ...
    <div className="modulo-invitado">
      ...
      <main className="contenido-404">
        <div className="card-404">
          ...
          <a href="#" className="btn-primario"><i className="fas fa-home"></i> Volver al inicio</a>
        </div>
      </main>
        ...
        <div className="contenedor-pie">
          ...
          <div className="seccion-pie">
            ...
            <ul className="enlaces-pie">
              ...
              <li><a href="#"><i className="fas fa-sign-in-alt"></i> Iniciar sesion</a></li>
            </ul>
          </div>
          <div className="seccion-pie">
            <h3>Contacto</h3>
